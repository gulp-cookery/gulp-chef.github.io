...
function PluginListCtrl($scope, $http, $location, $q) {
	...
	var makeRequest = function (start, size) {
		return $http.get('http://npmsearch.com/query', {
			params: {
				q: ['keywords:gulp-ccr', 'keywords:gulpccr', 'keywords:gulpchefplugin', 'keywords:gulpcheffriendly'],
				fields: fields.join(','),
				start: start,
				size: size,
				sort: 'rating:desc'
